...
public class Log {
    ...
    private ZonedDateTime logDate; // ZonedDateTime 사용
    ...
    public Log(String id, String modelName, String projectName, String inputData, String outputData, String apiKey,
            ZonedDateTime logDate, String isItEval, String formattedDate) { // 생성자에 formattedDate 추가
        this.id = id;
        ...
        this.apiKey = apiKey;
        this.logDate = logDate.withZoneSameInstant(ZoneId.of("Asia/Seoul")); // 서울 시간대로 설정
